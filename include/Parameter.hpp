...
class SimulationParameter {
  ...
  public:
    ...
    SimulationParameter(size_t total_num_people, size_t infected_people,
        ...
        float recovery_rate, size_t healthcare_capacity, float lx, float rx, float uy, float dy, size_t simu_step, size_t mode, float move_step, float spread_range)
      ...
      m_healthcare_capacity(healthcare_capacity), m_simu_step(simu_step), m_mode(mode), m_move_step(move_step), m_spread_range(spread_range),
      g_person_status(total_num_people), draw_health(0), draw_infected(0), draw_recovered(0), draw_dead(0) {
